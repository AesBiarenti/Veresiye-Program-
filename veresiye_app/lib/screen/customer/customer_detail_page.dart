...
void showDetailBottomSheet(
    Customer customer, BuildContext context, WidgetRef ref) {
              ...
              TextButton(
                onPressed: () {
                  ...
                  ref
                      ...
                      .addOrderDetailToCustomer(customer.id, newOrderDetail);
              ...
              Expanded(
                ...
                child: SingleChildScrollView(
                  child: DataTable(
                    ...
                    rows: customer.orderDetails.map((orderDetail) {
                      return DataRow(
                        cells: [
                          DataCell(TextButton(
                              onPressed: () {
                                _showUpdateDialog(
                                    context, ref, customer, orderDetail);
                              },
                          ...
                          DataCell(
                            IconButton(
                              ...
                              onPressed: () {
                                ...
                                ref
                                    .read(customersProvider.notifier)
                                    .removeOrderDetailFromCustomer(
                                        customer.id, orderDetail.id);
                                Navigator.of(context).pop();
                              },
                            ),
                          ),
...
void _showUpdateDialog(BuildContext context, WidgetRef ref, Customer customer,
        ...
        actions: [
          TextButton(
            onPressed: () {
              ...
              ref
                  .read(customersProvider.notifier)
                  .updateOrderDetailOfCustomer(customer.id, updatedOrderDetail);
